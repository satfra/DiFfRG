...
namespace DiFfRG
{
  namespace Flows
  {
    lambda9_integrator::lambda9_integrator(QuadratureProvider &quadrature_provider, std::array<uint, 1> grid_sizes,
    ...
    void lambda9_integrator::set_T(const double T, const double E) { integrator->set_T(T, E); }
