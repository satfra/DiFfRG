...
#include <DiFfRG/physics/integration_finiteT/integrator_angle_finiteTq0_gpu.hh>
...
TEMPLATE_TEST_CASE_SIG("Test gpu momentum integrals with angle finite T (q0)", "[integration][quadrature integration]",
                       ((int dim), dim), (3), (4))
{
